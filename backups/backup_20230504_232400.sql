...
CREATE TABLE `asesores` (
  ...
  CONSTRAINT `asesores_ibfk_2` FOREIGN KEY (`fk_id_usuario`) REFERENCES `usuarios` (`idusuarios`) ON UPDATE CASCADE
...
INSERT INTO `asesores` VALUES (9,'Juan Hernandez de la Cruz','Juandelacruz@gmail.com','304338087',4,'1',9),(10,'Luciana Carolina Jaimes Serrano','lucajase@gmail.com','3143378977',3,'2',10),(11,'Luis Felipe Calderon Calderon','Luiscalderonx2@gmail.com','3213539987',1,'3',11),(12,'Andrea Forero Camargo','andrecam074@gmail.com','3043255621',4,'4',12);
...
INSERT INTO `citaasesor` VALUES (3,1,3),(8,3,1);
...
INSERT INTO `citatratamiento` VALUES (6,1,3),(8,2,3);
...
INSERT INTO `horariosase` VALUES (1,'101','Martes 5pm',0,9),(2,'101','Miercoles 10am',0,9),(3,'101','Jueves 2pm',0,9),(4,'101','Martes 6pm',1,9),(5,'101','Martes 7pm',1,9),(6,'101','Lunes 1pm',1,9),(7,'102','Martes 6pm',1,10),(8,'102','Lunes 1pm',1,10);
...
INSERT INTO `horariostrat` VALUES (1,1,'Lunes 10am',0),(2,1,'Martes 5pm',0),(3,2,'Lunes 4pm',1),(4,2,'Miercoles 8am',1),(5,3,'Martes 9am',1),(6,3,'sabado 2pm',1),(7,4,'Martes 1pm',1),(8,3,'sabado 2pm',1);
...
INSERT INTO `usuarios` VALUES (1,'jesus bonillla','jesusenriquebonillaespana1@gmail.com','$2a$10$m3V8JTHElM5jCxxaIODA7eCbvL94YzkweD2uuhSZD1qVi.OaCuQ3W','calle 58 #30-67',31474834,1006958104,NULL,1),(3,'michael hernandez','michael@gmail.com','$2a$10$m3V8JTHElM5jCxxaIODA7eCbvL94YzkweD2uuhSZD1qVi.OaCuQ3W','bucaricas',34748364,1204358104,NULL,1),(7,'juank','juank@gmail.com','$2a$10$m3V8JTHElM5jCxxaIODA7eCbvL94YzkweD2uuhSZD1qVi.OaCuQ3W','calle 58 #30-67',31474834,1006958104,NULL,3),(9,'Juan Hernandez De la Cruz','Juandelacruz@gmail.com','$2a$10$m3V8JTHElM5jCxxaIODA7eCbvL94YzkweD2uuhSZD1qVi.OaCuQ3W','cra 45 #30-68',30433807,1009957184,NULL,2),(10,'Luciana Carolina Jaimes Serrano','lucajase@gmail.com','$2a$10$m3V8JTHElM5jCxxaIODA7eCbvL94YzkweD2uuhSZD1qVi.OaCuQ3W','cra 52 #30-67',314337897,1892675345,NULL,2),(11,'Luis Felipe Calderon Calderon','Luiscalderonx2@gmail.com','$2a$10$m3V8JTHElM5jCxxaIODA7eCbvL94YzkweD2uuhSZD1qVi.OaCuQ3W','calle 45 #30-43',321353998,1049957184,NULL,2),(12,'Andrea Forero Camargo','andrecam07@gmail.com','$2a$10$m3V8JTHElM5jCxxaIODA7eCbvL94YzkweD2uuhSZD1qVi.OaCuQ3W','calle 54 #32-43',304325562,1022475345,NULL,2);
...
-- Dump completed on 2023-05-04 23:24:00
